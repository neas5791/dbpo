	...
	<body>
		<div class="wrapper">
			...
			<form method="POST">
				...
				<div><label for="category">Category Code:</label>
					<input type="text" name="category" id="category" value="<?php htmlout($category);?>" <?php if($action == 'deleteform' || $action == 'editform') { echo "disabled";};?>>
				</div>
